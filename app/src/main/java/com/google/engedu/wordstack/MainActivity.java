...
public class MainActivity extends AppCompatActivity {
    ...
    protected boolean onStartGame(View view) {
        ...
        while(count1!=word1.length() || count2!=word2.length())
        {
            ...
            {
                shuffled += word2.charAt(count2++);
            }
            else if(count1 != word1.length() && count2 == word2.length())
            {
                shuffled += word1.charAt(count1++);
            }
            else
            {
                shuffled += random.nextBoolean()?word1.charAt(count1++):word2.charAt(count2++);
            }
        }
        ...
        {
            stackedLayout.push(new LetterTile(MainActivity.this,shuffled.charAt(i)));
        }
